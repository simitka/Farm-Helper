...
# Удаление скриптов firstStart.sh и downloadProject.sh
echo "Удаление старых скриптов..."
if [[ -f firstStart.sh ]]; then
    rm -f firstStart.sh
    echo "Скрипт firstStart.sh удален."
else
    echo "Скрипт firstStart.sh не найден."
fi

if [[ -f downloadProject.sh ]]; then
    rm -f downloadProject.sh
    echo "Скрипт downloadProject.sh удален."
else
    echo "Скрипт downloadProject.sh не найден."
fi
